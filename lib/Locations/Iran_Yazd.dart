...
class YazdPage extends StatefulWidget {
  @override
  State<YazdPage> createState() => _YazdPageState();
}

class _YazdPageState extends State<YazdPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=yazd&units=metric&appid=5360942d4f43add177f84f37183adf4d');

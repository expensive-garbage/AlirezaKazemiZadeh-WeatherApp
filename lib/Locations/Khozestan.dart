...
class KhozestanPage extends StatefulWidget {
  @override
  State<KhozestanPage> createState() => _KhozestanPageState();
}

class _KhozestanPageState extends State<KhozestanPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=ahvaz&units=metric&appid=5360942d4f43add177f84f37183adf4d');

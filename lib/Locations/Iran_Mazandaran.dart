...
class MazandaranPage extends StatefulWidget {
  @override
  State<MazandaranPage> createState() => _MazandaranPageState();
}

class _MazandaranPageState extends State<MazandaranPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=mazandaran&units=metric&appid=5360942d4f43add177f84f37183adf4d');

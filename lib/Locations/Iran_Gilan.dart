...
class GilanPage extends StatefulWidget {
  @override
  State<GilanPage> createState() => _GilanPageState();
}

class _GilanPageState extends State<GilanPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=Rasht&units=metric&appid=5360942d4f43add177f84f37183adf4d');

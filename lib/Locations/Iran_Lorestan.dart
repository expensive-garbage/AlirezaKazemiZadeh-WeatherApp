...
class LorestanPage extends StatefulWidget {
  @override
  State<LorestanPage> createState() => _LorestanPageState();
}

class _LorestanPageState extends State<LorestanPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=lorestan&units=metric&appid=5360942d4f43add177f84f37183adf4d');

...
class BushehrPage extends StatefulWidget {
  @override
  State<BushehrPage> createState() => _BushehrPageState();
}

class _BushehrPageState extends State<BushehrPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=Bushehr&units=metric&appid=5360942d4f43add177f84f37183adf4d');

...
class UrmiaPage extends StatefulWidget {
  @override
  State<UrmiaPage> createState() => _UrmiaPageState();
}

class _UrmiaPageState extends State<UrmiaPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=Urmia&units=metric&appid=5360942d4f43add177f84f37183adf4d');

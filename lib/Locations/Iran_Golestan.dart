...
class GolestanPage extends StatefulWidget {
  @override
  State<GolestanPage> createState() => _GolestanPageState();
}

class _GolestanPageState extends State<GolestanPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=Golestan&units=metric&appid=5360942d4f43add177f84f37183adf4d');

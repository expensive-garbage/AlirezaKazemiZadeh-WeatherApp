...
class KordestanPage extends StatefulWidget {
  @override
  State<KordestanPage> createState() => _KordestanPageState();
}

class _KordestanPageState extends State<KordestanPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=sanandaj&units=metric&appid=5360942d4f43add177f84f37183adf4d');

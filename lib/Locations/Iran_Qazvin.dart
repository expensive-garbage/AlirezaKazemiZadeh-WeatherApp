...
class QazvinPage extends StatefulWidget {
  @override
  State<QazvinPage> createState() => _QazvinPageState();
}

class _QazvinPageState extends State<QazvinPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=qazvin&units=metric&appid=5360942d4f43add177f84f37183adf4d');

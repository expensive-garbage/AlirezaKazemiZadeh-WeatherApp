...
class QomPage extends StatefulWidget {
  @override
  State<QomPage> createState() => _QomPageState();
}

class _QomPageState extends State<QomPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=qom&units=metric&appid=5360942d4f43add177f84f37183adf4d');

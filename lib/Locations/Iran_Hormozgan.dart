...
class HormozganPage extends StatefulWidget {
  @override
  State<HormozganPage> createState() => _HormozganPageState();
}

class _HormozganPageState extends State<HormozganPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=hormozgan&units=metric&appid=5360942d4f43add177f84f37183adf4d');

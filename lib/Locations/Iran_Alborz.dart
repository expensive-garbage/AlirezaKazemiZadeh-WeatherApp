...
class AlborzPage extends StatefulWidget {
  @override
  State<AlborzPage> createState() => _AlborzPageState();
}

class _AlborzPageState extends State<AlborzPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=Alborz&units=metric&appid=5360942d4f43add177f84f37183adf4d');

...
class IsfahanPage extends StatefulWidget {
  @override
  State<IsfahanPage> createState() => _IsfahanPageState();
}
...
class _IsfahanPageState extends State<IsfahanPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=Isfahan&units=metric&appid=5360942d4f43add177f84f37183adf4d');

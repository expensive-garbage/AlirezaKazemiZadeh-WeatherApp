...
class TabrizPage extends StatefulWidget {
  @override
  State<TabrizPage> createState() => _TabrizPageState();
}

class _TabrizPageState extends State<TabrizPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=Tabriz&units=metric&appid=5360942d4f43add177f84f37183adf4d');

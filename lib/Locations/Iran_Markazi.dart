...
class MarkaziPage extends StatefulWidget {
  @override
  State<MarkaziPage> createState() => _MarkaziPageState();
}

class _MarkaziPageState extends State<MarkaziPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=markazi&units=metric&appid=5360942d4f43add177f84f37183adf4d');

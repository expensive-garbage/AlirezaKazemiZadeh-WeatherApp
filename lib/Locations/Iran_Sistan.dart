...
class SistanPage extends StatefulWidget {
  @override
  State<SistanPage> createState() => _SistanPageState();
}

class _SistanPageState extends State<SistanPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=zahedan&units=metric&appid=5360942d4f43add177f84f37183adf4d');
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        const Padding(
                          ...
                          child: Text(
                            "دمای کنونی هوا در سیستان و بلوچستان",
                            style: TextStyle(
                                color: Colors.black,
                                fontFamily: 'Sahel',
                                fontSize: 14,

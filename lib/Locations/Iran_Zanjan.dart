...
class ZanjanPage extends StatefulWidget {
  @override
  State<ZanjanPage> createState() => _ZanjanPageState();
}

class _ZanjanPageState extends State<ZanjanPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=Zanjan&units=metric&appid=5360942d4f43add177f84f37183adf4d');

...
class ArdabilPage extends StatefulWidget {
  @override
  State<ArdabilPage> createState() => _ArdabilPageState();
}

class _ArdabilPageState extends State<ArdabilPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=Ardabil&units=metric&appid=5360942d4f43add177f84f37183adf4d');

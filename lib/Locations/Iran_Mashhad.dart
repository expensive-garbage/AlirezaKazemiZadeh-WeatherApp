...
class MashhadPage extends StatefulWidget {
  @override
  State<MashhadPage> createState() => _MashhadPagePageState();
}

class _MashhadPagePageState extends State<MashhadPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=Mashhad&units=metric&appid=5360942d4f43add177f84f37183adf4d');

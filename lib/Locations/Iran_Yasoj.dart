...
class YasojPage extends StatefulWidget {
  @override
  State<YasojPage> createState() => _YasojPageState();
}

class _YasojPageState extends State<YasojPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        const Padding(
                          ...
                          child: Text(
                            "دمای کنونی هوا در کهگیلویه و بویراحمد",
                            style: TextStyle(
                                color: Colors.black,
                                fontFamily: 'Sahel',
                                fontSize: 14,

...
class HamadanPage extends StatefulWidget {
  @override
  State<HamadanPage> createState() => _HamadanPageState();
}

class _HamadanPageState extends State<HamadanPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=Hamadan&units=metric&appid=5360942d4f43add177f84f37183adf4d');

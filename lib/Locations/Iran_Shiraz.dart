...
class ShirazPage extends StatefulWidget {
  @override
  State<ShirazPage> createState() => _ShirazPageState();
}
...
class _ShirazPageState extends State<ShirazPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=Shiraz&units=metric&appid=5360942d4f43add177f84f37183adf4d');

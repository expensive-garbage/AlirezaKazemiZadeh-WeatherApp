...
class Semnanpage extends StatefulWidget {
  @override
  State<Semnanpage> createState() => _SemnanpageState();
}

class _SemnanpageState extends State<Semnanpage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=semnan&units=metric&appid=5360942d4f43add177f84f37183adf4d');

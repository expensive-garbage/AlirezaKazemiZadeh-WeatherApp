...
class BirjandPage extends StatefulWidget {
  @override
  State<BirjandPage> createState() => _BirjandPagePageState();
}

class _BirjandPagePageState extends State<BirjandPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=birjand&units=metric&appid=5360942d4f43add177f84f37183adf4d');
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        const Padding(
                          ...
                          child: Text(
                            "دمای کنونی هوا در خراسان جنوبی",
                            style: TextStyle(
                                color: Colors.black,
                                fontFamily: 'Sahel',
                                fontSize: 14,

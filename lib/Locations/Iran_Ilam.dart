...
class IlamPage extends StatefulWidget {
  @override
  State<IlamPage> createState() => _IlamPageState();
}

class _IlamPageState extends State<IlamPage> {
  var temp;
  var discription;
  var currently;
  var humidity;
  ...
  Future<void> getWeather() async {
    Uri url = Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=Īlām&units=metric&appid=5360942d4f43add177f84f37183adf4d');
